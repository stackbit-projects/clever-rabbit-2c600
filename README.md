...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/6012c6002a759000158bb7b5
...
To start editing your site, you can use the Sanity interface at https://clever-rabbit-2c600.sanity.studio/.
...
Generated at `2021-01-28T14:15:54.587Z` by Stackbit version `0.3.44`.